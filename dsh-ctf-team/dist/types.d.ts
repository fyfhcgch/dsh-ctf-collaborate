...
export declare class TeamInputError extends Error {
    readonly kind: 'invalid' | 'conflict' | 'unsupported';
    constructor(message: string, kind?: 'invalid' | 'conflict' | 'unsupported');
}
